    ...
    return (
        <html>
            ...
            <body>
                ...
                <div class="container">
                    ...
                    <div class="style=display: flex;">
                        ...
                        <h1 style="display:inline-block;">1. Boil
                            water</h1>
                    ...
                    <div class="style=display: flex;">
                        ...
                        <h1 style="display:inline-block;">2. Salt
                            water</h1>
                    ...
                    <div class="style=display: flex;">
                        ...
                        <h1 style="display:inline-block;">3. Put
                    ...
                    <div class="style=display: flex;">
                        ...
                        <h1 style="display:inline-block;">4. While
                    ...
                    <div class="style=display: flex;">
                        ...
                        <h1 style="display:inline-block;">5. Remove
                            pot from heat and <a type="button" onClick="togglePanel"
                    ...
                    <div id="video" class="popover" style="max-width: 100%;">
                        <div>
                            <button type="button" onClick="togglePanel" style="font-size: 20px; display:inline-block; padding-left: 15px; padding-right: 15px"
                            data-toggle="collapse" title="How to
                            Strain Pasta" data-target="#video">X</button>
                        <h4 style="font-size: 20px; display:inline-block; font-family: 'Coming Soon'; font-style: normal; font-weight: 400;">How to Strain Pasta</h4>
                    </div>
            ...
            <div class="style=display: flex;">
                ...
                <h1 style="display:inline-block;">6. In the
            ...
            <div class="style=display: flex;">
                ...
                <h1 style="display:inline-block;">7. Mix
