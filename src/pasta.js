        ...
        <html>
                    ...
                    <div class="style=display: flex;">
                        <button type="button" class="btn btn-primary dropdown-toggle"
                            data-toggle="collapse" data-target="#salt"><span
                                class="caret"></span></button>
                        <h1 style="display:inline-block">2. Salt water</h1>
                        <div id="salt" class="collapse">
                            <p><span class="tab"></span>1. Once the water is boiling,
                    ...
                    <div class="style=display: flex;">
                        <button type="button" class="btn btn-primary dropdown-toggle"
                            data-toggle="collapse" data-target="#cookNoodles"><span
                                class="caret"></span></button>
                        <h1 style="display:inline-block">3. Put uncooked pasta in water
                            and read pasta box for how long pasta should cooked</h1>
                        <div id="cookNoodles" class="collapse">
                            <p><span class="tab"></span>1. Look on the side of the box
                                for how long to boil the pasta</p>
                            <p><span class="tab"></span>2. Stir occassionally to make
                    ...
                    <div class="style=display: flex;">
                        <button type="button" class="btn btn-primary dropdown-toggle"
                            data-toggle="collapse" data-target="#heatSauce"><span
                                class="caret"></span></button>
                        <h1 style="display:inline-block">4. While pasta is boiling, heat
                            pasta sauce in the sauce pan</h1>
                        <div id="heatSauce" class="collapse">
                            <p><span class="tab"></span>1. Put the sauce in a small
                                sauce pan</p>
                            <p><span class="tab"></span>2. Put the pan on the stovetop
                                and set to a medium heat</p>
                            <p><span class="tab"></span>3. Wait about 10 minutes, or
                    ...
                    <div class="style=display: flex;">
                        <button type="button" class="btn btn-primary dropdown-toggle"
                            data-toggle="collapse" data-target="#strain"><span
                                class="caret"></span></button>
                        <h1 style="display:inline-block">5. Remove pot from heat and <a
                            type="button" data-toggle="collapse" title="How to
            Strain Pasta" data-target="#video">strain pasta</a></h1>
                        <div id="video" class="popover">
            ...
            encrypted-media; gyroscope; picture-in-picture"
                        ...
                        <div id="strain" class="collapse">
                            ...
                            <p><span class="tab"></span>2. Pour hot contents from pot
                                into the colander</p>
                            <p><span class="tab"></span>3. The water will be very hot,
                    ...
                    <div class="style=display: flex;">
                        <button type="button" class="btn btn-primary dropdown-toggle"
                            data-toggle="collapse" data-target="#mix"><span
                                class="caret"></span></button>
                        <h1 style="display:inline-block">6. In the large pot, add cooked
                            pasta and heated sauce</h1>
                        <div id="mix" class="collapse">
                            <p><span class="tab"></span>1. Put the pasta from the
                                colander back into the large pot</p>
                            <p><span class="tab"></span>2. Remove the sauce from the
                    ...
                    <div class="style=display: flex;">
                        <button type="button" class="btn btn-primary dropdown-toggle"
                            data-toggle="collapse" data-target="#enjoy"><span
                                class="caret"></span></button>
                        <h1 style="display:inline-block">7. Mix together, add garnishes,
                            and enjoy!</h1>
                        <div id="enjoy" class="collapse">
                            <p><span class="tab"></span>1. Stir the contents of in the
                                pot to make sure the sauce covers all of the pasta</p>
                            <p><span class="tab"></span>2. Add any desired toppings such
